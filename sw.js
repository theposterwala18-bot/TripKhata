const CACHE='tripkhata-v081';
const ASSETS=[
  './','./index.html','./manifest.webmanifest',
  './version.js?v=081','./member-v022.js','./settlement-v023.js','./ux-v024.js',
  ...
  './support-owner-v080.js?v=080','./nav-persist-v080.js?v=080','./shared-trip-v080.js?v=081','./privacy.html','./delete-account.html'
];
