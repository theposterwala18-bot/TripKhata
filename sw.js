const CACHE='tripkhata-v031';
const ASSETS=['./','./index.html','./manifest.webmanifest','./version.js','./member-v022.js','./settlement-v023.js','./ux-v024.js','./ledger-v026.js','./statement-v027.js','./finish-v030.js'];
